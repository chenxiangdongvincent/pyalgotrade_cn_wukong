...
wsddata1 = w.wsd("000001.SZ", "open,high,low,close,volume,amt","2017-5-1",datetime.today()-timedelta(1))
#printpy(wsddata1)
...
fm['CLOSE'].plot(color='black')
plt.show()
"""

"""
#提取财务数据  空值
wsddata2 = w.wsd("000001.SZ", "tot_oper_rev,tot_oper_cost,opprofit,net_profit_is","2010-5-1",datetime.today()-timedelta(1),"Fill=Previous")
fm2=pd.DataFrame(wsddata2.Data, index= wsddata2.Fields, columns=wsddata2.Times)
print fm2.T
"""

#分钟序列
wsidata = w.wsi("000001.SZ","close,amt","2017-5-18 14:06:15","2017-5-18 14:56:15")
#fm3 = pd.DataFrame(wsidata, index = wsidata.Fields, columns = wsidata.Times)
#print fm3.T
printpy(wsidata)
